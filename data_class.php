...
class data extends db {
    ...
    function mainLogin($t1, $t2) {

        $q="SELECT * FROM main where email='$t1' and pass='$t2'";
        $recordSet=$this->connection->query($q);
        $result=$recordSet->rowCount();
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookaudor, $bookpub, $branch, $bookprice, $bookquantity) {
       ...
       $q="INSERT INTO book (id,bookpic,bookname, bookdetail, bookaudor, bookpub, Category, bookprice,bookquantity,bookava,bookrent)VALUES('','$bookpic', '$bookname', '$bookdetail', '$bookaudor', '$bookpub', '$branch', '$bookprice', '$bookquantity','$bookquantity',0)";
