...
<html>
  ...
  <!-- <link rel="apple-touch-icon" sizes="180x180" href="D:\Apps\Xampp\htdocs\redketchup/apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="D:\Apps\Xampp\htdocs\redketchup/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="D:\Apps\Xampp\htdocs\redketchup/favicon-16x16.png">
<link rel="manifest" href="D:\Apps\Xampp\htdocs\redketchup/site.webmanifest"> -->
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <input type="text" name="bookpub"/></br><div>Category:
            <input type="radio" name="branch" value="Fiction"/>Fiction
            <input type="radio" name="branch" value="Non-Fiction"/>Non-Fiction
            <input type="radio" name="branch" value="Tech"/>Tech
            <input type="radio" name="branch" value="Non-Tech"/>Non-Tech
            <input type="radio" name="branch" value="Magazine"/>Magazine</div>  
